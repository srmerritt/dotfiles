...
syn match   pythonFunction	"[a-zA-Z_][a-zA-Z0-9_]*" display nextgroup=pythonFirstArg skipwhite contained
syn match   pythonFirstArg "([a-zA-Z_][a-zA-Z0-9_]*" display contained
syn match   pythonDeclaration "[a-zA-Z_][a-zA-Z0-9_]*.*$" display contained
...
syn match   pythonDecorator	"@[a-zA-Z_][a-zA-Z0-0_.]*" display
